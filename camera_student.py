...
def main() -> None:
    ...
    ap.add_argument("--fps", type=int, default=60, help="Match cameraLogi.py default (30)")
    ap.add_argument(
        "--backend",
    ...
    ap.add_argument(
        ...
        type=int,
        default=8,
        help="Run model every N frames (higher = less inference, higher UI FPS; lower = snappier overlay)",
    )
    ap.add_argument(
        "--threads",
        type=int,
